...
Revision ID: 768d43bde052
Revises: 
Create Date: 2024-10-25 19:00:42.721499
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum("teacher", "student", name="role_types"), nullable=True),
